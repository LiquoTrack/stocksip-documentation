#### 6.2.3.4. Testing Suite Evidence for Sprint Review 3 ####
...
|----------------------------------|---------------------|-----------|---------------------------------------------------------|-------------|
| LiquoTrack/stocksip-platform-api | feature/careguide | 44adbf9   | tests: add unit tests for Warehouse and CareGuide aggregates | 05/12/2025  |
