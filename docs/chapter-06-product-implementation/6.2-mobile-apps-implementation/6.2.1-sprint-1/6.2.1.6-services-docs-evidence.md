...
Endpoint: /api/v1/accounts/{accountId}/products - POST
- Descripción: Registra un producto dentro de una cuenta.

- Parámetros:
  - AccountId: Identificador de la cuenta.

- Ejemplo de llamada:
    - GET /api/v1/accounts/1/products

- Request Body:

<p align="center">
  <img src="https://i.imgur.com/0L8YWuV.png" alt="account-1">
</p>

- Respuesta (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/0L8YWuV.png" alt="account-2">
</p>

Endpoint: /api/v1/accounts/{accountId}/warehouses - POST
- Descripción: Registra un almacén dentro de una cuenta.

- Parámetros:
    - AccountId: Identificador de la cuenta.

- Ejemplo de llamada:
    - GET /api/v1/accounts/1/warehouses

- Request Body:

<p align="center">
  <img src="https://i.imgur.com/pKMZ2KB.png" alt="account-3">
</p>

- Respuesta (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/4kup0UE.png" alt="account-4">
</p>

### Plans

Endpoint: /api/v1/plans/- GET
- Descripción: Obtener todos los planes
...
<p align="center">
  <img src="https://i.imgur.com/eUqH0aB.png" alt="plans-1">
</p>

### Products

Endpoint: /api/v1/products/{id} - GET
...
<p align="center">
  <img src="https://i.imgur.com/dgWy3SH.png" alt="products-1">
</p>

- Response (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/RQmC24U.png" alt="products-2">
</p>

### Profiles

Endpoint: /api/v1/profiles/{id} - GET
- Descripción: Obtiene un perfil por su id.

- Ejemplo de llamada:
    - POST /api/v1/profiles/1

- Parámetros:
    - ProfileId: Identificador del perfil.

- Request:

<p align="center">
  <img src="https://i.imgur.com/rmEGcUH.png" alt="users-1">
</p>

- Response (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/lU8fTgd.png" alt="users-2">
</p>
...
<p align="center">
  <img src="https://i.imgur.com/8SICKTT.png" alt="users-1">
</p>

- Response (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/zgxxLDx.png" alt="users-2">
</p>

### Warehouses

Endpoint: /api/v1/warehouses/{warehouseId} - DELETE
- Descripción: Elimina un almacén por su id.

- Ejemplo de llamada:
    - POST /api/v1/warehouses/1

- Parámetros:
    - WarehouseId: Identificador del almacén.

- Request body:

<p align="center">
  <img src="https://i.imgur.com/BTZp7OR.png" alt="warehouse-1">
</p>

- Response (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/Tmq8RLm.png" alt="warehouse-2">
</p>

### Authentication

Endpoint: /api/v1/sign-up - POST
- Descripción: Registra una nueva cuenta en el sistema.
...
<p align="center">
  <img src="https://i.imgur.com/Y821r7a.png" alt="authentication-1">
</p>

- Response (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/2lgaV7F.png" alt="authentication-2">
</p> 

Endpoint: /api/v1/sign-in - POST
...
<p align="center">
  <img src="https://i.imgur.com/q93fdUY.png" alt="authentication-1">
</p>

- Response (200 Ok):

<p align="center">
  <img src="https://i.imgur.com/VoTQ8yK.png" alt="authentication-2">
</p>