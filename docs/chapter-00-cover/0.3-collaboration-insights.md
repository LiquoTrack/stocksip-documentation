...
<p align="center">
  <img src="https://i.imgur.com/doJUxMg.png"/>
</p>

Finalmente, este gráfico representa la cantidad de commits realizados por cada miembro del equipo en el repositorio del proyecto. Cada barra representa a un miembro del equipo y la altura de la barra indica el número total de commits realizados por esa persona.

## TF1 (05/12/25): Reporte de la colaboración del proyecto

Respecto del último avance del informe del proyecto, cada miembro del equipo realizó un aporte en el desarrollo de las actividades para completar este informe. Las actividades realizadas en este avance corresponden al diseño de interfaces para la aplicación multiplataforma. Además, se añadió la sección de desarrollo e implementación de productos para el sprint 3. A continuación, se describen resumidamente los aportes realizados por cada integrante:

- La integrante Camila Huamani añadio la tabla de evidencias de commits en cada repositorio, asi como las recomendaciones y conclusiones finales.
- El integrante Matías Diaz desarrollo la tabla del sprint backlog 3.
- El integrante Farid Coronel desarrollo las evidencias de despliegue de la aplicación movil nativa en Android y de la aplicación multiplataforma.   
- El integrante Nicolas Juarez completo la sección sprint planning y backlog del sprint 3. Además del despliegue de la aplicación móvil multiplataforma.

<p align="center">
  <img src="https://i.imgur.com/SV2uO2S.png"/>
</p>
